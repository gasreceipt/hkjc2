    ...
    <>
                    ...
                    <tbody>
                      {race.runners.map((runner) => (
                        <tr
                          key={runner.no}
                          tabIndex={0}
                          className="cursor-pointer border-t border-line transition hover:bg-white/5 focus-visible:bg-white/5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-gold"
      ...
      {selectedRunner ? (
        <RunnerDialog
          ...
          open={Boolean(selectedRunner)}
          onOpenChange={(isOpen) => {
            if (!isOpen) setSelectedRunner(null);
          }}
        />
      ) : null}
    </>
